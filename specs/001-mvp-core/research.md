...
- 매출 예측은 퍼센트보다 “몇 만원 높게/낮게 예측했는지”와 “예상 범위”가 점주 의사결정에 더 직접적임
...
- 매출 화면에는 평균 절대 금액오차, WAPE, signed error(높게/낮게 예측)를 표시한다
...
- signed error는 예측이 보수적인지 공격적인지 보여준다. 같은 8만원 오차라도 높게 예측한 것과 낮게 예측한 것은 운영 해석이 다르다
